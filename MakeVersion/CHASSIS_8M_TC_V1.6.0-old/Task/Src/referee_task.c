...
{
    Rectangle_Draw(&Left_Rect, "301", UI_Graph_ADD, 3, UI_Color_White, 20, 900, 300, 940, 300);
    Rectangle_Draw(&Right_Rect, "303", UI_Graph_ADD, 3, UI_Color_White, 20, 980, 300, 1020, 300);
    Rectangle_Draw(&Mid_Rect, "302", UI_Graph_ADD, 3, UI_Color_White, 20, 940, 300, 980, 300);
}
void Drow_AimMode(void)
{
    Rectangle_Draw(&Left_Rect, "301", UI_Graph_ADD, 3, UI_Color_Yellow, 20, 900, 300, 940, 300);
}
...
void Update_AimMode(void)
{
    if(debug == 0)//未识别 左侧点亮
    {
            Rectangle_Draw(&Left_Rect, "301", UI_Graph_Change, 3, UI_Color_Yellow, 20, 900, 300, 940, 300);
    Rectangle_Draw(&Right_Rect, "303", UI_Graph_Change, 3, UI_Color_White, 20, 980, 300, 1020, 300);
    Rectangle_Draw(&Mid_Rect, "302", UI_Graph_Change, 3, UI_Color_White, 20, 940, 300, 980, 300);  
    }
    else if(debug == 1)//已经识别 中间点亮
    {
            Rectangle_Draw(&Left_Rect, "301", UI_Graph_Change, 3, UI_Color_White, 20, 900, 300, 940, 300);
    Rectangle_Draw(&Right_Rect, "303", UI_Graph_Change, 3, UI_Color_White, 20, 980, 300, 1020, 300);
    Rectangle_Draw(&Mid_Rect, "302", UI_Graph_Change, 3, UI_Color_Green, 20, 940, 300, 980, 300);
    ...
    {
            Rectangle_Draw(&Left_Rect, "301", UI_Graph_Change, 3, UI_Color_White, 20, 900, 300, 940, 300);
    Rectangle_Draw(&Right_Rect, "303", UI_Graph_Change, 3, UI_Color_Orange, 20, 980, 300, 1020, 300);
    Rectangle_Draw(&Mid_Rect, "302", UI_Graph_Change, 3, UI_Color_White, 20, 940, 300, 980, 300);
...
{
    Circle_Draw(&Diff_Angle_Circle, "400", UI_Graph_ADD, 4, UI_Color_White, 5, 960, 540, 200);
}
void Drow_Gimbal_Chassis_Angle(void)
{
    uint32_t start_angle = loop_fp32_constrain(0 -45 -180,0,360);
    uint32_t end_angle = loop_fp32_constrain(0 +45 -180,0,360);
    Arc_Draw(&Diff_Angle_Arc,"401",UI_Graph_ADD , 4, UI_Color_Main ,start_angle,end_angle,5,960,540,200,200);
}
void Update_Gimbal_Chassis_Angle(void)
{
    uint32_t start_angle = loop_fp32_constrain(Get_dif_angle() -45 -180,0,360);
    uint32_t end_angle = loop_fp32_constrain(Get_dif_angle() +45 -180,0,360);
    Arc_Draw(&Diff_Angle_Arc,"401",UI_Graph_Change , 4, UI_Color_Main ,start_angle,end_angle,5,960,540,200,200);
